...
//         // determine if user is logged in or gues
...
//                 cart.products[productIndex].quantity = quantity
//             } else {
//                 cart.products.splice(productIndex, 1) // remove product if quntity is 0
//             }
...
//             } else {
//                 // if the user has no exiting cart, adding the guest cart to the user
...
//         } else {
//             if (userCart) {
//                 // guest car has already merged, return user cart
//                 return res.status(200).json(userCart)
//             }
